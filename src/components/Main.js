...
const Main = () => {
  return (
    <div className='d-flex-column d-lg-flex ps-3 my-5 container'>
      <div className='me-4'>
        <h2>CampusExchange</h2>
        <h3 style={{color:"#9171f8"}}>You Can Feel Good Shopping Interaction</h3>
        <p className='mt-4'>
            CampusExchange is an online platform that will help the students of a college to buy and sell their belongings conveniently. It will be secure and one stop market place for all the students of a college. <br />
