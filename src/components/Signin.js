...
const Signin = (props) => {
  ...
  return (
    <div className="container mt-5 d-flex justify-content-center">
      <div className="rounded-5 " style={{height:"37rem",width:"22rem",backgroundColor:"#46424f",display:"flex",flexDirection:"column",alignItems:"center"}}>
        <h2 className='mt-4' style={{color:"#9171f8"}}>Login to continue</h2>
        ...
        <div className='mt-4'>
            Are you to CampusExchange? <button className='btn ms-2' onClick={handleClick}>Join Us</button>
        </div>
      </div>
    </div>
  )
